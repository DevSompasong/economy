        ...
        <article className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
          ...
          <div className="p-6 sm:p-10">
            ...
            <div className="prose prose-lg max-w-none text-slate-700">
              {/* 1. ส่วนบทนำ (สีฟ้า) ใช้แสดงคำโปรยสั้นๆ */}
              <div className="text-xl leading-relaxed font-medium text-slate-600 mb-8 p-6 bg-blue-50/50 rounded-2xl border-l-4 border-blue-500 italic">
                {article.description_th || article.description}
              </div>

              {/* 2. ส่วนเนื้อหาหลัก (ใหม่) ใช้แสดงข่าวฉบับเต็มจาก AI */}
              <div className="whitespace-pre-wrap leading-loose text-lg text-slate-800 space-y-6">
                {article.content || "ขออภัย ระบบกำลังสรุปเนื้อหาเพิ่มเติม..."}
              </div>

              {/* 3. เพิ่มหมายเหตุเล็กๆ เพื่อความน่าเชื่อถือ */}
              <p className="mt-8 text-sm text-gray-400 italic border-t pt-4">
                หมายเหตุ: เนื้อหาข่าวส่วนนี้เรียบเรียงและขยายความโดยระบบ AI
                เพื่อสรุปประเด็นสำคัญ โปรดตรวจสอบข้อมูลจากแหล่งข่าวต้นฉบับ
              </p>
            </div>
