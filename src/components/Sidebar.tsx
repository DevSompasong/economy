...
// const MARKET_DATA = [
//   { name: "S&P 500", value: "5,218.19", change: "+0.52%", up: true },
//   { name: "NASDAQ", value: "16,399.52", change: "+0.70%", up: true },
//   { name: "DOW", value: "39,127.14", change: "-0.11%", up: false },
//   { name: "BTC", value: "$68,412", change: "+1.23%", up: true },
//   { name: "EUR/USD", value: "1.0831", change: "+0.03%", up: true },
//   { name: "GOLD", value: "$2,331", change: "+0.42%", up: true },
// ];
...
//                 </div>
//                 <div
//                   className={`flex items-center justify-end gap-0.5 text-[10px] font-semibold ${item.up ? "text-emerald-600" : "text-red-500"}`}
//                 >
//                   {item.up ? (
...
//                   <p className="text-xs font-semibold text-slate-800 line-clamp-2 leading-snug group-hover:text-blue-700 transition-colors">
//                     {article.title}
//                   </p>
...
//         <AdBanner
//           slot="sidebar"
//           className="min-h-[250px] bg-gray-50/50 rounded-lg border border-dashed border-gray-200"
//         />
//         <p className="text-[9px] text-gray-400 text-center mt-2 uppercase">
//           Advertisement
//         </p>
//       </div>
//     </aside>
...
const INITIAL_MARKET = [
  ...
  { name: "NASDAQ", value: 16399.52, change: 0.70, up: true },
  { name: "DOW", value: 39127.14, change: -0.11, up: false },
  { name: "BTC", value: 68412.00, change: 1.23, up: true },
  { name: "EUR/USD", value: 1.0831, change: 0.03, up: true },
  { name: "GOLD", value: 2331.50, change: 0.42, up: true },
];
...
export default function Sidebar({ trendingArticles }: SidebarProps) {
  ...
  return (
    <aside className="space-y-5">
      ...
      {/* ส่วน Trending และ AdBanner ด้านล่างคงเดิม... */}
      {trendingArticles.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100 bg-slate-50">
            <TrendingUp className="w-4 h-4 text-slate-600" />
